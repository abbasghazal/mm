...
LOGGER_USERNAME = getenv("LOGGER_USERNAME",'LOGSHAHM')
OWNER_ID = int(getenv("OWNER_ID", "6848908141"))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ali414a44ali/CR7")
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "matrix.png")
PING_IMG_URL = getenv("PING_IMG_URL", "matrix.png")
